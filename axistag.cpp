   ...
   mPlot(parentAxis)
{
  ...
  mDummyTracer->position->setAxisRect(mPlot->axisRect());
  mDummyTracer->position->setAxes(0, mPlot->axisRect(), );
...
void AxisTag::updatePosition(double value)
{
  ...
  mArrow->end->setCoords(mDummyTracer->position->coords().rx(), 0);
}
